...
public class Math extends Subject{
    ...
    public Math(int asgScore1, int asgScore2, int asgScore3, int examScore1, int examScore2, double finalScore) {
    ...
    public void display(Scanner scan, int idx, ArrayList<Teacher> teache, ArrayList<Student> studen, Data data){
        ...
        System.out.println("============================");
        back(scan, idx, teache, studen, data);
    }

    public void back(Scanner scan, int idx, ArrayList<Teacher> teache, ArrayList<Student> studen, Data data){
        System.out.println();
